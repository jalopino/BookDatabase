...
public class EditBooks extends AppCompatActivity {
    ...
    private static String urlHost = "https://e4e3-49-145-174-8.ngrok.io/bookdatabase/UpdateQty.php";
    ...
    public static final String AUTHOR = "GENDER";
    public static final String PUBLISHER = "CIVIL";
    public static final String DATEPUB = "CIVIL";
